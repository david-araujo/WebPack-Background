...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *@name: scripts.js
	 *
	 *@description: File which is responsable to require
	 *other Java Script modules in this folder.
	 *
	 */
...
/***/ function(module, exports) {
	...
	var CARS = {
	      ...
	      audi: [{ model: 'A3', year: '2015', color: ['black', 'white', 'red'] }, { model: 'Q5', year: '2014', color: ['black', 'white', 'red'] }, { model: 'A1', year: '2009', color: ['black', 'white', 'red'] }],
	      ferrari: [{ model: 'Spider', year: '2016', color: ['black', 'white', 'red', 'blue'] }, { model: 'F50', year: '2012', color: ['black', 'white', 'red', 'blue'] }, { model: 'F40', year: '2010', color: ['black', 'white', 'red', 'blue'] }],
	      mercedes: [{ model: 'Kompressor', year: '2004', color: ['black', 'white', 'red', 'blue'] }, { model: 'AMD', year: '2006', color: ['purple', 'white', 'red', 'blue'] }, { model: 'F1', year: '2016', color: ['black', 'white', 'red', 'blue'] }],
	
	      /** @description: Objects being looped in scope */
	
	      printAudi: function printAudi() {
	
	            console.log('Audi Cars Models:');
	
	            try {
	
	                  CARS.audi.forEach(function (element, index) {
	                        console.log(index + ' - ' + ' Model: ' + element.model + ' - ' + ' Year: ' + element.year + ' - ' + ' Colors Available: ' + ' [ ' + element.color + ' ] ');
	                  });
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Audi is now loaded');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('loadAudi')[0].appendChild(loaded);
	            }
	      },
	      printFerrari: function printFerrari() {
	
	            console.log('Ferrari Cars Models:');
	
	            try {
	
	                  CARS.ferrari.forEach(function (element, index) {
	                        console.log(index + ' - ' + ' Model: ' + element.model + ' - ' + ' Year: ' + element.year + ' - ' + ' Colors Available: ' + ' [ ' + element.color + ' ] ');
	                  });
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Ferrari is now loaded');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('loadFerrari')[0].appendChild(loaded);
	            }
	      },
	      printMercedes: function printMercedes() {
	
	            console.log('Mercedes Cars Models:');
	
	            try {
	
	                  CARS.mercedes.forEach(function (element, index) {
	                        console.log(index + ' - ' + ' Model: ' + element.model + ' - ' + ' Year: ' + element.year + ' - ' + ' Colors Available: ' + ' [ ' + element.color + ' ] ');
	                  });
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Mercedes is now loaded');
	      ...
	      printFilterAudi: function printFilterAudi() {
	
	            console.log('Audi cars newer than 2009:');
	
	            try {
	
	                  CARS.audi.filter(function (car) {
	                        return car.year > '2009';
	                  ...
	                  var text = document.createTextNode('Audi query');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('queryAudi')[0].appendChild(loaded);
	            }
	      },
	      printFilterFerrari: function printFilterFerrari() {
	
	            console.log('Ferrari cars matching Spider:');
	
	            try {
	
	                  CARS.ferrari.filter(function (car) {
	                        return car.model === 'Spider' || car.model === 'F50';
	                  }).forEach(function (element, index) {
	                        console.log(index + ' - ' + ' Model: ' + element.model + ' - ' + ' Year: ' + element.year + ' - ' + ' Colors Available: ' + ' [ ' + element.color + ' ] ');
	                  });
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Ferrari query');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('queryFerrari')[0].appendChild(loaded);
	            }
	      },
	      printFilterMercedes: function printFilterMercedes() {
	
	            console.log('Mercedes cars newer or equal 2004 and color black:');
	
	            try {
	
	                  CARS.mercedes.filter(function (car) {
	                        return car.year >= '2004' && car.color[0] !== 'purple';
	                  }).forEach(function (element, index) {
	                        console.log(index + ' - ' + ' Model: ' + element.model + ' - ' + ' Year: ' + element.year + ' - ' + ' Colors Available: ' + ' [ ' + element.color + ' ] ');
	                  });
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Mercedes query');
	      ...
	      audiFilterObject: function audiFilterObject(object) {
	
	            try {
	
	                  var _object = CARS.audi.filter(function (car) {
	                        return car.year > '2009';
	                  });
	                  ...
	                  var text = document.createTextNode('Audi Object');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('objectAudi')[0].appendChild(loaded);
	            }
	      },
	      ferrariFilterObject: function ferrariFilterObject(object) {
	
	            try {
	
	                  var _object2 = CARS.ferrari.filter(function (car) {
	                        return car.model === 'Spider' || car.model === 'F50';
	                  });
	
	                  console.log('Ferrari\'s Cars ' + ' (' + 'Matching Spider and F50 Models' + ') ' + ' Objects:');
	                  console.log(_object2);
	            } catch (err) {
	                  ...
	                  var text = document.createTextNode('Ferrari Object');
	
	                  loaded.appendChild(text);
	                  document.getElementsByClassName('objectFerrari')[0].appendChild(loaded);
	            }
	      },
	      mercedesFilterObject: function mercedesFilterObject(object) {
	
	            try {
	
	                  var _object3 = CARS.mercedes.filter(function (car) {
	                        return car.year >= '2004' && car.color[0] !== 'purple';
	                  });
	                  ...
	                  var text = document.createTextNode('Mercedes Object');
	      ...
	      carsObject: function carsObject() {
	            ...
	            try {
	                  ...
	                  var text = document.createTextNode('Cars Object');
	      ...
	      init: function init(start) {
	            start = [CARS.printAudi(), CARS.printFerrari(), CARS.printMercedes(), CARS.carsObject(), CARS.printFilterAudi(), CARS.audiFilterObject(), CARS.printFilterFerrari(), CARS.ferrariFilterObject(), CARS.printFilterMercedes(), CARS.mercedesFilterObject()];
	      }
	};
	...
	var PROGRAMMERS = {
	  ...
	  filterEach: function filterEach(person) {
	    ...
	    try {
	      ...
	      for (var i in PROGRAMMERS.backend) {
	        ...
	        console.log({ objContainer: objContainer });
	      }
	    }
	  ...
	  init: function init(start) {
	    start = [console.log(PROGRAMMERS.filterData()), console.log(PROGRAMMERS.filterUser()), console.log(PROGRAMMERS.filterEach())];
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arr = ['New York', 'Sao Paulo', 'Toquio'];
	...
	var builder = function builder(listItem) {
